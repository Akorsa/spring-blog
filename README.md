...
properties in _/resources/META-INF/spring/mysql.properties_ file. The tests in both JPA and MVC modules use a
database.hbm2ddl.auto create-drop setting and should run with a simple $gradle jpa:test or $gradle mvc:test. The H2 create-data
script for the tests is located in _/resources/db._
